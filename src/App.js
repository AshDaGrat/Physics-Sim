...
import './App.css';
import { PhysicsBody, Newtonian_Gravity } from './physics';

const G = 6.6743e-11; 

function App() {
  const body1 = useRef(new PhysicsBody('Body1', 0, -15, 200, 400, 10, 0, 1, 'green'));
  const body2 = useRef(new PhysicsBody('Body2', 0, 0, 500, 400, 10, 0, 1e15, 'blue'));
